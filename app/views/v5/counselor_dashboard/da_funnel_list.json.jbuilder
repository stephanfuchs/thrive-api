json.status do
  json.details do
    json.list(@direct_program_applications) do |direct_program_application|
      json.application_id direct_program_application.explore_application_id
      ...
      json.is_ucas @direct_apply_programs_hash[direct_program_application.direct_apply_program_id]&.is_ucas || ''
    end
